...
CREATE TABLE instruction (`id` int(10) NOT NULL AUTO_INCREMENT, `rank`int(2) NOT NULL, `description` varchar(500) NOT NULL, `image_id` int(10), `recipe_id` int(10) NOT NULL, PRIMARY KEY (`id`), FOREIGN KEY (`image_id`) REFERENCES `image` (`id`) ON UPDATE CASCADE, FOREIGN KEY (`recipe_id`) REFERENCES `recipe` (`id`) ON DELETE CASCADE ON UPDATE CASCADE);
